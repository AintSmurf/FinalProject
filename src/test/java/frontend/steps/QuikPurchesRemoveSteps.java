...
public class QuikPurchesRemoveSteps {
    ...
    public void i_open_my_list_tap()  {
        textContext.getHomePage().openFastPurches();
        //        textContext.myList().initPage();
    }

    @When("I add the these products to the list:")
    public void i_add_the_these_products_to_the_list(List<String> productsToAdd) throws InterruptedException {
